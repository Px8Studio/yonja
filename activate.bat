@echo off
REM ═══════════════════════════════════════════════════════════════════════
REM 🌿 ALİM - Quick Environment Activation (CMD version)
REM ═══════════════════════════════════════════════════════════════════════
...
echo.
echo 🌿 Activating ALİM environment...
...
if exist ".venv\Scripts\activate.bat" (
    ...
    echo    uvicorn alim.api.main:app --reload   # Start API
...
:info
echo.
echo 🌿 ALİM Development Environment
echo ═══════════════════════════════════════════════════════════════
echo.
echo 📦 Option 1: Use Poetry Shell (Recommended)
echo    poetry shell
echo    uvicorn alim.api.main:app --reload
...
echo    .venv\Scripts\python.exe -m uvicorn alim.api.main:app --reload
