...
revision: str = 'chainlit_tables_001'
down_revision: Union[str, Sequence[str], None] = '3fe49b8713dd'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('identifier', sa.String(length=255), nullable=False, comment='User identifier (email from OAuth)'),
        sa.Column('createdAt', sa.String(length=30), nullable=False, comment='ISO timestamp of creation'),
        sa.Column('metadata', sa.Text(), nullable=True, comment='JSON metadata including chat_settings'),
    ...
    op.create_table(
        'threads',
        sa.Column('id', sa.String(length=36), nullable=False, comment='UUID primary key'),
        sa.Column('createdAt', sa.String(length=30), nullable=True, comment='ISO timestamp of creation'),
        ...
        sa.Column('userIdentifier', sa.String(length=255), nullable=True, comment='User identifier (denormalized)'),
    ...
    op.create_table(
        ...
        sa.Column('type', sa.String(length=50), nullable=True, comment='Step type (user_message, assistant_message, etc)'),
        sa.Column('threadId', sa.String(length=36), nullable=True, comment='FK to threads.id'),
        sa.Column('parentId', sa.String(length=36), nullable=True, comment='Parent step ID for nested steps'),
        sa.Column('streaming', sa.Boolean(), nullable=True, comment='Whether step is streaming'),
        sa.Column('waitForAnswer', sa.Boolean(), nullable=True, comment='Whether waiting for user answer'),
        ...
        sa.Column('createdAt', sa.String(length=30), nullable=True, comment='ISO timestamp of creation'),
        sa.Column('start', sa.String(length=30), nullable=True, comment='ISO timestamp of step start'),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(length=36), nullable=False, comment='UUID primary key'),
        sa.Column('threadId', sa.String(length=36), nullable=True, comment='FK to threads.id'),
        sa.Column('type', sa.String(length=50), nullable=True, comment='Element type (image, file, etc)'),
        sa.Column('chainlitKey', sa.String(length=255), nullable=True, comment='Chainlit internal key'),
    ...
    op.create_table(
        'feedbacks',
        sa.Column('id', sa.String(length=36), nullable=False, comment='UUID primary key'),
        sa.Column('forId', sa.String(length=36), nullable=True, comment='Step ID this feedback is for'),
        sa.Column('threadId', sa.String(length=36), nullable=True, comment='Thread ID'),
        sa.Column('value', sa.Integer(), nullable=True, comment='Feedback value (1=positive, -1=negative)'),
