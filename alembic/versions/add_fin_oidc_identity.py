...
down_revision: Union[str, None] = 'make_chainlit_user_nullable'  # After all Chainlit tables setup
...
def upgrade() -> None:
    ...
    op.create_index('idx_user_profiles_provider_sub', 'user_profiles', ['provider_sub'], unique=True)
    op.create_index('idx_user_profiles_ektis_farmer_id', 'user_profiles', ['ektis_farmer_id'], unique=False)
