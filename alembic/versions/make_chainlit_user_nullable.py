...
def upgrade() -> None:
    ...
    op.alter_column("alem_personas", "chainlit_user_id", existing_type=sa.String(36), nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column(
        "alem_personas", "chainlit_user_id", existing_type=sa.String(36), nullable=False
    )
