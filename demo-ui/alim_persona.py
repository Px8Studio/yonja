# demo-ui/alim_persona.py
"""ALİM Persona Provisioning System — JIT (Just-In-Time) Agricultural Identity.
...
class PersonaProvisioner:
    ...
    - Rich agricultural context required for ALİM demonstrations
    """
    ...
    def provision_from_oauth(
        ...
        existing_persona: ALİMPersona | None = None,
    ) -> ALİMPersona:
        """Generate or return ALİM persona from OAuth claims.
        ...
        Returns:
            ALİMPersona instance (new or existing)
    ...
    @staticmethod
    def generate_gold_standard_scenario(scenario_name: str) -> ALİMPersona:
        ...
        how ALİM adapts advice based on farmer profile.
