...
class AlimClient:
    ...
    Example:
        ```python
        async with AlimClient("http://localhost:8000") as client:
    ...
    async def __aenter__(self) -> "AlimClient":
        """Enter async context."""
    ...
    def client(self) -> httpx.AsyncClient:
        ...
        if self._client is None:
            raise RuntimeError("AlimClient not initialized. Use 'async with' context.")
        return self._client
