...
class LangfuseInsightsClient:
    ...
    def __init__(
        ...
        logger.info(
            f"LangfuseInsightsClient configured: host={self.host}, key_prefix={key_preview}"
        )
    ...
    async def get_trace_metadata(self, trace_id: str) -> ResponseMetadata | None:
        ...
        try:
            ...
            nodes = [
                obs.get("name", "unknown") for obs in observations if obs.get("type") == "SPAN"
            ]
    ...
    async def get_user_insights(
        ...
        try:
            ...
            timestamps = [
                datetime.fromisoformat(t["timestamp"].replace("Z", "+00:00")) for t in traces
            ]
