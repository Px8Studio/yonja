# src/ALİM/agent/nodes/agronomist.py
...
def load_system_prompt() -> str:
    ...
    return """Sən "ALİM" adlı Azərbaycan fermerlərinə kömək edən süni intellekt köməkçisisən.
...
async def agronomist_node(
    ...
    try:
        from alim.mcp.handlers import get_zekalab_handler
