# src/ALİM/observability/__init__.py
"""Observability module for ALİM.
...
Usage:
    from alim.observability import create_langfuse_handler
...
from alim.observability.banner import (
    Colors,
    format_trace_link,
    print_database_info,
    print_endpoints,
