# src/ALİM/observability/langfuse.py
...
4. Set ALİM_LANGFUSE_SECRET_KEY and ALİM_LANGFUSE_PUBLIC_KEY in .env
...
def get_langfuse_client() -> Langfuse | None:
    ...
    if not settings.langfuse_secret_key or not settings.langfuse_public_key:
        logger.warning(
            ...
            "Set ALİM_LANGFUSE_SECRET_KEY and ALİM_LANGFUSE_PUBLIC_KEY. "
...
def create_langfuse_handler(
    ...
    try:
        ...
        # Merge ALİM version/fingerprint metadata
        version_meta = _get_alim_version_metadata()
...
# ============================================================
# ALİM Version Metadata Loader
# ============================================================


def _get_alim_version_metadata() -> dict:
    """Load ALİM version and fingerprints from alim_version.toml.

    Returns a dict suitable for Langfuse metadata, e.g.:
    {
        "ALİM": {"version": "0.1.0", "updated_at": "..."},
        "models": {
    ...
    try:
        path = os.path.join(os.getcwd(), "alim_version.toml")
        ...
        if isinstance(data, dict):
            if "ALİM" in data:
                out["ALİM"] = {
                    "version": data["ALİM"].get("version"),
                    "updated_at": data["ALİM"].get("updated_at"),
                }
            if "models" in data:
                out["models"] = {
