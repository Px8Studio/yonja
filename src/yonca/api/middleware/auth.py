# src/yonca/api/middleware/auth.py
...
class JWTAuthenticator:
    ...
    # Required scopes for Yonca API access
    ...
    def _get_cached(self, token: str) -> Optional[TokenPayload]:
...
def create_token(
    ...
    payload = {
        ...
        "tier": tier,
        "scope": " ".join(scopes or ["yonca:read", "yonca:chat"]),
    }
